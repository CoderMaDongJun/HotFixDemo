...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *sourcePath = [[NSBundle mainBundle] pathForResource:JSName ofType:@"js"];
    NSString *script = [NSString stringWithContentsOfFile:sourcePath encoding:NSUTF8StringEncoding error:nil];
    [JPEngine evaluateScript:script];
    
    self.window = [[UIWindow alloc] initWithFrame:[UIScreen mainScreen].bounds];
    JPViewController *rootViewController = [[JPViewController alloc] init];
    [rootViewController.view addSubview:[self greenView]];
...
- (UIView *)greenView
{
    UIView *view = [[UIView alloc] initWithFrame:CGRectMake(10, 230, 200, 200)];
